...
?>
        ...
        <section class="sidebar-page-container sec-pad-2">
            <div class="auto-container">
                ...
                <h2 class="ml-3 my-2">Resultado para <?php echo $_GET['texto']; ?></h2>
                        ...
                        <section class="news-section blog-grid">
                            <div class="auto-container">
                                ...
                                if (isset($_GET['limite'])) {
                                    ...
                                    WHERE t1.titulo LIKE '$texto%' OR t1.periodista LIKE '$texto%' OR t2.descripcion LIKE '$texto%'
                                    && t1.status = 1 ORDER BY t1.id DESC LIMIT ".$_GET['limite'].",".$limite." ";      
                                    ...
                                    ON t1.id_categoria = t2.id 
                                    WHERE t1.titulo LIKE '$texto%' OR t1.periodista LIKE '$texto%' OR t2.descripcion LIKE '$texto%'
                                    && t1.status = 1 ORDER BY t1.id DESC LIMIT ".$limite." ";      
                                }  
                            ...
                            if (mysqli_num_rows($result) > 0) {                                                        
                                while ($fila = mysqli_fetch_array($result)) {
                                    ...
                                    <?php 
                                        ...
                                        echo "<h3 class='ml-3 my-4'>Sin resultados para '".$_GET['texto']."'</h3>";
                                    }
                                    ?>
                                    ...
                                    <ul class="pagination clearfix">
                                        <?php 
                                            ...
                                            if (isset($_GET['limite'])) {
                                                ...
                                                echo '<li>
                                                        <a href="noticia-search.php?texto='.$texto.'&limite='.($_GET['limite']-10).'">
                                            ...
                                            for ($k=0; $k < $totalBotones ; $k++) { 
                                                echo '<li><a href="noticia-search.php?texto='.$texto.'&limite='.($k*10).'">'.($k+1).'</a></li>';
                                            }
                                            ...
                                            if (isset($_GET['limite'])) {
                                                ...
                                                echo '<li>
                                                        <a href="noticia-search.php?texto='.$texto.'&limite=10">
                                                            <i class="far fa-angle-double-right"></i>
                                                        </a>
                                                    </li>';
                                            }
