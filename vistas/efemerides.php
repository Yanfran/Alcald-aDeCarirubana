...
<h4 class="page-title">Efemérides</h4>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="tb-efemerides" class="table table-hover table-condensed" width="100%">
                            <thead>
                                <tr>
...
<!-- END: .main-content -->
<div class="main-content" id="nueva_efemeride" style="display: none">
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formEfemerides" name="formEfemerides">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label" style="position: relative;top: 2px;">Decripción</label>
                                        <div class="" style="height: 55px;">
                                            <input type="text" class="form-control" name="txtdescripcion" id="idtxtdescripcion"
                                                placeholder="Ingrese una descripción" style="position: relative;top: -2px;"
                                                onkeyPress="return alfaNumerica(event)">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label" style="position: relative;top: 2px;">URL</label>
                                        <div class="" style="height: 55px;">
                                            <input type="text" class="form-control" name="txturl" id="idtxturl"
                                                placeholder="Ingrese una URL" style="position: relative;top: -2px;"
                                                >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" style="position: relative;top: 2px;">
                                            Imagen referencial recomendada <b class="text-danger">"370px X 400px"</b>
                                        </label>
                                        <div class="" style="height: 55px;">
    ...
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formEfemeridesEditar" name="formEfemeridesEditar">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label" style="position: relative;top: 2px;">Decripción</label>
                                        <div class="" style="height: 55px;">
                                            <input type="text" class="form-control" name="txtdescripcion" id="idtxtdescripcionE"
                                                placeholder="Ingrese una descripción" style="position: relative;top: -2px;"
                                                onkeyPress="return alfaNumerica(event)">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label" style="position: relative;top: 2px;">URL</label>
                                        <div class="" style="height: 55px;">
                                            <input type="text" class="form-control" name="txturl" id="idtxturlE"
                                                placeholder="Ingrese una URL" style="position: relative;top: -2px;"
                                                >
                                        </div>
                                    </div>
...
$("#btnnuevo-paquete").click(function() {
    ...
    $("#nueva_efemeride").css('display', 'block');
