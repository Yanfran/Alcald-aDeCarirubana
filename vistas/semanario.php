...
<h4 class="page-title">Semanario</h4>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="tb-semanario" class="table table-hover table-condensed" width="100%">
                            <thead>
                                <tr>
...
<!-- END: .main-content -->
<div class="main-content" id="nuevo_semanario" style="display: none">
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formSemanario" name="formSemanario">
    ...
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formSemanarioEditar" name="formSemanarioEditar">
...
$("#btnnuevo-paquete").click(function() {
    ...
    $("#nuevo_semanario").css('display', 'block');
