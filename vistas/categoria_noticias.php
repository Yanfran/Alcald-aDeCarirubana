...
<h4 class="page-title">Categoria Noticias</h4>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="tb-categoria_noticias" class="table table-hover table-condensed" width="100%">
                            <thead>
                                <tr>
...
<!-- END: .main-content -->
<div class="main-content" id="nueva_categoria_noticias" style="display: none">
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formCategoriaNoticias" name="formCategoriaNoticias">
    ...
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formCategoriaNoticiasEditar" name="formCategoriaNoticiasEditar">
...
$("#btnnuevo-paquete").click(function() {
    ...
    $("#nueva_categoria_noticias").css('display', 'block');
