...
<h4 class="page-title">Libros y Revistas</h4>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="tb-libros-revistas" class="table table-hover table-condensed" width="100%">
                            <thead>
                                <tr>
...
<!-- END: .main-content -->
<div class="main-content" id="nuevo_libro_revista" style="display: none">
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formLibrosRevistas" name="formLibrosRevistas">
    ...
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formLibrosRevistasEditar" name="formLibrosRevistasEditar">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" id="txtdocumentoA">
...
$("#btnnuevo-paquete").click(function() {
    ...
    $("#nuevo_libro_revista").css('display', 'block');
