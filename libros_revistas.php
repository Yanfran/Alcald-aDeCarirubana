...
?>
                                        ...
                                        <ul class="othre-info clearfix" style="padding-top: 210px;">                     
                                            <li class="share-option" style="margin-left: 0px!important;">
                                                ...
                                                <ul class="share-links clearfix">
                                                    ...
                                                    <li>
                                                        <a href="https://twitter.com/intent/tweet?text=Libros y Revistas&url=https://alcaldiadecarirubana.com/semanario.php" target="_blank">
                                                            <i class="fab fa-twitter"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="https://api.whatsapp.com/send?text=Libros y Revistas%20https://alcaldiadecarirubana.com/semanario.php" target="_blank">
                                                            <i class="fab fa-whatsapp"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="https://www.facebook.com/sharer/sharer.php?u=https://alcaldiadecarirubana.com/semanario.php" target="_blank">
        ...
        <script src="assets-from/js/libros_revistas.js"></script>