...
?>
                                        ...
                                        <ul class="othre-info clearfix" style="padding-top: 210px;">                     
                                            <li class="share-option" style="margin-left: 0px!important;">
                                                ...
                                                <ul class="share-links clearfix">
                                                    ...
                                                    <li>
                                                        <a href="https://twitter.com/intent/tweet?text=Semanario&url=https://alcaldiadecarirubana.com/semanario.php" target="_blank">
                                                            <i class="fab fa-twitter"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="https://api.whatsapp.com/send?text=Semanario%20https://alcaldiadecarirubana.com/semanario.php" target="_blank">
        ...
        <script src="assets-from/js/semanario.js"></script>
